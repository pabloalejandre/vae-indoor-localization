...
from utils.data_utils import MyDataset, get_MDP_from_data, pad_and_sort_MDPs, find_shortest_sequence_length, truncate_mdps
...
receiver_MDPs = get_MDP_from_data(path='data/' + scenario_name + '/training.json', receiver_id=1, number_of_transmitters=1, timestamps=1500)
...
receiver_MDPs_padded = truncate_mdps(receiver_MDPs_padded, shortest_seq_length)

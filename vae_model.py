...
class Encoder(nn.Module):
    def __init__(self, feature_length, latent_dim):
        ...
        self.fc_mean = nn.Linear(in_features= 10, out_features=latent_dim)
        self.fc_logvar = nn.Linear(in_features= 10, out_features=latent_dim)        
...
class Decoder(nn.Module):
    def __init__(self, latent_dim, feature_length):
        ...
        self.fc1 = nn.Linear(in_features=latent_dim, out_features=10)
        self.fc2 = nn.Linear(in_features=10, out_features=32)
    ...
    def forward(self, z):
        ...
        reconstruction = torch.unsqueeze(reconstruction, 1)
